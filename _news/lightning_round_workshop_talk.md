...
<a href="{{ '/assets/img/cdc_2025.jpeg' | relative_url }}">
  <img src="{{ '/assets/img/cdc_2025.jepg' | relative_url }}" alt="Stochastic Planning & Control of Dynamical Systems" style="max-width: 300px; border-radius: 5px; display: block; margin-top: 15px;">
</a>