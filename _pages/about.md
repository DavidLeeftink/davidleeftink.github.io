...
On the *theoretical* side, I study how ideas from optimal control theory translate to deep reinforcement learning. My aim is to root modern reinforcement learning algorithms in the notions of <span style="color: var(--global-theme-color)">safety</span>, <span style="color: var(--global-theme-color)">robustness</span>, and <span style="color: var(--global-theme-color)">stability</span>. These are **essential** characteristics of intelligent decision-making in **high-stakes** applications such as healthcare, energy systems, and robotics.
